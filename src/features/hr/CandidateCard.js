...
function CandidateCard({ candidate }) {
  ...
  // Handler untuk navigasi ke halaman profil kandidat
  const handleViewProfile = () => {
    // Navigasi ke halaman profil dengan ID kandidat
    // Anda perlu menyesuaikan ID berdasarkan data yang tersedia
        ...
        <div>
          ...
          <div className="mt-4 flex items-center gap-6 text-sm text-gray-600 border-t pt-3 flex-wrap">
            <div className="flex items-center gap-2">
              ...
              <span>
                Last work at <strong>{currentCompany}</strong>
              </span>
            </div>
            <div className="flex items-center gap-2">
