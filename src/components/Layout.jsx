...
        // HAPUS LOGIKA HR DISINI AGAR TIDAK DOBEL
      ];
    }

    // 2. Tambahkan Menu HR di Akhir (Hanya Satu Kali)
    if (userRole === 'hr' || userRole === 'admin') {
       items = [
         ...items, // Ambil menu user yang sudah dibuat di atas
...
                key={idx}
                onClick={() => {
                  if (item.label === "My Resumes") { // Cek label, bukan properti isMyResumes yg tidak ada
